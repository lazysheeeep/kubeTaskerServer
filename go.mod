...
require (
	...
	github.com/argoproj/argo-workflows/v3 v3.5.2 // indirect
...
replace github.com/argoproj/argo-workflows v2.5.2+incompatible => /root/go/pkg/mod/github.com/argoproj/argo-workflows
