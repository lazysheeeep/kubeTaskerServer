...
// swagger:route post /k8sconfigmap/get_config_maps k8sconfigmap GetConfigMaps
//
// getConfigMaps
//
// getConfigMaps
...
//
// Responses:
//  200: GetConfigMapsResp

func GetConfigMapsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetConfigMapsReq
		if err := httpx.Parse(r, &req, true); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := k8sconfigmap.NewGetConfigMapsLogic(r.Context(), svcCtx)
